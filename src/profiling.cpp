...
long run_legacy()
{
    vector<IPv4Address> ip_pool { create_pool(1e6) };
...
long run_range_v3()
{
    ...
    auto result1 = filter_rng(ip_pool, 1);
    auto result2 = filter_rng(ip_pool, 46, 70);
    auto result3 = filter_any_rng(ip_pool, 46);
